...
void initialisebrigetable(BridgeEntry** bridgetable);
/*Check if there is an entry for the mac address in the bridge table*/
int presentInbridgeTable(BridgeEntry** bridgetable,unsigned char * mac);
/*Add to the existing bridge table entry*/
void addTobridgeTable(BridgeEntry** bridgetable,unsigned char * mac,int sockfd);
...
int getIface(BridgeEntry** bridgetable,unsigned char * mac);
...
void displaytableinfo(BridgeEntry** bridgetable);
...
/*Add to the existing bridge table entry*/
void addTobridgeTable(BridgeEntry** bridgetable,unsigned char * mac,int index)
{
 int i;
